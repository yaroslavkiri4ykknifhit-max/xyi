...
export const BANNER_GRADIENTS = [
  ...
  { id: "gold", name: "Ocean Breeze", style: "linear-gradient(135deg, #0a1128 0%, #001f54 50%, #FF5500 100%)" },
  ...
  return (
    <div className="fixed inset-0 z-55 flex items-center justify-center bg-black/75 backdrop-blur-lg px-4 select-text animate-fadeIn">
      <div className="w-full max-w-2xl glass-panel rounded-[16px] border-[#FF5500]/25 shadow-[0_24px_64px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col md:flex-row relative max-h-[90vh]">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-50 p-2 rounded-2xl bg-black/40 hover:bg-white/10 border border-white/5 text-zinc-400 hover:text-white transition-all cursor-pointer"
        >
          <X className="w-4 h-4" />
        </button>
        ...
        <div className="w-full md:w-[240px] bg-black/40 border-b md:border-b-0 md:border-r border-white/5 p-6 flex flex-col gap-6 items-center justify-center flex-shrink-0">
          ...
          <div className="w-full max-w-[200px] bg-[#08080c] border border-[#FF5500]/20 rounded-2xl overflow-hidden flex flex-col shadow-2xl select-none group relative">
            {/* Card Banner */}
            <div 
            ...
            <div className="w-full px-4 relative flex flex-col items-center -mt-8 pb-4">
              <div 
                className="w-14 h-14 rounded-2xl border-2 border-[#FF5500]/35 flex items-center justify-center shadow-lg relative overflow-hidden transition-all duration-300 bg-zinc-950"
              ...
              <div className="text-center mt-2 w-full flex flex-col gap-1">
                ...
                {/* Card Bio */}
                <p className="text-[9px] text-zinc-400 font-medium px-1 mt-1 line-clamp-2 italic break-words leading-tight bg-black/20 p-1.5 rounded-2xl border border-white/3 min-h-[28px] flex items-center justify-center">
            ...
            <button
              ...
              className="mt-3 w-full py-2 bg-zinc-900 hover:bg-white/5 border border-white/5 hover:border-[#FF5500]/30 rounded-2xl text-[9px] font-black uppercase tracking-widest text-zinc-400 hover:text-white transition-all cursor-pointer flex items-center justify-center gap-1.5 shadow-sm active:scale-95"
            >
        ...
        <form onSubmit={handleSaveSubmit} className="flex-1 p-8 flex flex-col gap-6 overflow-y-auto min-h-0 text-left select-text">
          ...
          {isDbTableMissing && (
            <div className="p-3.5 bg-amber-500/10 border border-amber-500/20 rounded-2xl flex gap-3 text-left">
          ...
          <div className="grid grid-cols-3 bg-black/40 p-1 rounded-2xl border border-white/5">
            <button
              ...
              className={`py-2 rounded-2xl text-[10px] font-black uppercase tracking-wider transition-all duration-300 cursor-pointer flex items-center justify-center gap-1.5 ${
                activeTab === "info"
            ...
            <div className="flex flex-col gap-4 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-black/60 border border-white/8 rounded-2xl px-4 py-3.5 text-white text-xs focus:outline-none focus:border-[#FF5500] transition-all font-bold tracking-wider placeholder:font-normal placeholder:tracking-normal"
                  />
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex flex-wrap gap-2 p-2 bg-black/40 rounded-2xl border border-white/5 min-h-[46px] items-center justify-center">
                    {AVATAR_COLORS.map((col) => (
                      <button
                        ...
                        className={`w-6 h-6 rounded-2xl transition-transform active:scale-90 cursor-pointer flex items-center justify-center border border-black/30 ${
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  className="w-full bg-black/60 border border-white/8 rounded-2xl px-4 py-3 text-white text-xs focus:outline-none focus:border-[#FF5500] transition-all resize-none"
                />
              </div>
            </div>
          )}
          ...
          {activeTab === "avatar" && (
            <div className="flex flex-col gap-5 animate-fadeIn">
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-4 bg-black/40 p-4 border border-white/5 rounded-2xl">
                  <div 
                    onClick={() => avatarInputRef.current?.click()}
                    className="w-16 h-16 rounded-2xl border border-white/10 flex flex-col gap-1 items-center justify-center bg-black/50 hover:bg-white/5 transition-all cursor-pointer text-zinc-500 hover:text-white"
                  >
                  ...
                  <div className="flex flex-col gap-1 text-left min-w-0 flex-1">
                    <button
                      type="button"
                      onClick={() => avatarInputRef.current?.click()}
                      className="px-4 py-2 border border-white/10 hover:border-white/20 rounded-2xl bg-white/5 text-xs font-black uppercase tracking-wider cursor-pointer hover:bg-white/10 active:scale-[0.98] w-fit"
                    >
                ...
                <div className="grid grid-cols-7 gap-3 p-4 bg-black/40 rounded-2xl border border-white/5">
                  {AVATAR_PRESETS.map((emoji) => (
                    <button
                      ...
                      className={`h-11 rounded-2xl flex items-center justify-center text-xl transition-all cursor-pointer ${
                        avatarUrl === emoji 
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-4 bg-black/40 p-4 border border-white/5 rounded-2xl">
                  <div 
                    ...
                    className="w-16 h-12 rounded-2xl border border-white/10 flex flex-col gap-1 items-center justify-center bg-black/50 hover:bg-white/5 transition-all cursor-pointer text-zinc-500 hover:text-white"
                  >
                ...
                <div className="grid grid-cols-2 gap-3">
                  {BANNER_GRADIENTS.map((gradient) => (
                    <button
                      ...
                      className={`h-14 rounded-2xl p-3 flex flex-col justify-end text-left relative overflow-hidden transition-all duration-300 cursor-pointer ${
          ...
          <div className="flex items-center gap-3 mt-4">
            <button
              ...
              className="flex-1 py-4 bg-white hover:bg-zinc-200 text-black font-extrabold text-xs uppercase tracking-widest rounded-2xl transition-all active:scale-[0.98] disabled:opacity-40 disabled:pointer-events-none cursor-pointer flex items-center justify-center gap-2 shadow-lg"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-4 bg-black/40 hover:bg-white/5 border border-white/5 text-zinc-400 hover:text-white font-extrabold text-xs uppercase tracking-widest rounded-2xl transition-all active:scale-[0.98] cursor-pointer"
            >
              Отмена
            </button>
          </div>
